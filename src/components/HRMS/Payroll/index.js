						...
						<div className="container-fluid">
							...
							<div className="row clearfix">
								<div className="col-6 col-md-4 col-xl-3 ">
									<Link to="/hr-initiate-payroll" className="text-muted text-white text-bold">
								...
								<div className="col-6 col-md-4 col-xl-3 ">
									<Link to="/hr-past-payroll" className="text-muted text-white text-bold">
										<div className="card card-purple">
											<div className="card-body">
												<span>Past Payroll</span>
												<i style={{ float: 'right' }} className="fa fa-angle-double-right" />
											</div>
										</div>
									</Link>
								...
								{isAdmin && (
									<div className="col-6 col-md-4 col-xl-3 ">
										<Link to="/hr-users" className="text-muted text-white text-bold">
