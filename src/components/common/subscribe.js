        ...
        <div className="pricing-items">
          <div className="pricing-item">
            <div className="pricing-item-inner">
              ...
              <FlutterWaveButton {...fwConfig} />
                <button onClick={()=> this.subscribe(this.getPricingData(this.state.priceOutput.plan1, 1))} className="btn btn-primary" href="">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="pricing-item">
            <div className="pricing-item-inner">
              ...
              <div className="pricing-item-cta">
                <button onClick={()=> this.subscribe(this.getPricingData(this.state.priceOutput.plan2, 1))} className="btn btn-primary" href="">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="pricing-item">
            <div className="pricing-item-inner">
              ...
              <div className="pricing-item-cta">
                <button onClick={()=> this.subscribe(this.getPricingData(this.state.priceOutput.plan3, 1))} className="btn btn-primary" href="">
                  Subscribe
                </button>
              </div>
            </div>
